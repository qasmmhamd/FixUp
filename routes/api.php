...
use App\Http\Controllers\DashboardAdmin\ManagingWalletTransactionController;
    ...
    Route::middleware('role:admin')
        ...
        ->group(function () {
            ...
            */
            ...
            Route::get('/wallet-transactions', [ManagingWalletTransactionController::class, 'index']);
